...
See [CONTRIBUTING.md](https://github.com/THD-Spatial-AI/building-configurator/blob/main/CONTRIBUTING.md) for how to report bugs, request features, and submit pull requests.

Please read our [Code of Conduct](https://github.com/THD-Spatial-AI/building-configurator/blob/main/CODE_OF_CONDUCT.md) before participating.
